            ...
            <div className="flex flex-col">
                <section className="fixed">
                    <div className="flex w-screen">
                        ...
                        <div className="hidden tab:inline-block w-full bg-white">
                            <div className="flex justify-between items-center h-20 px-4 text-xl font-bold">
                                <div className=" grid grid-cols-2 gap-4">
                                    <a href="#Start" className="hover:text-blue-700">
                                        Inicio
                                    </a>
                                ...
                                <div>
                                    <Link className="flex items-center px-4 py-2 border text-white bg-blue-800 rounded-md font-bold hover:bg-blue-700 focus:outline-none" href={"login"}>
                                        Entrar
                                    </Link>
                                </div>
                            </div>
                ...
                <section id="Start" className="grid grid-cols-1 tab:grid-cols-2 h-screen">
